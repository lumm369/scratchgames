...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Play the best free online chicken games on ScratchGames.info. No registration required!',
    alternates: {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-white">
        <h2 className="text-2xl font-bold mb-2">Chicken Games</h2>
      </div>
